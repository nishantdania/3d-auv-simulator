...
class RosManager(object):
	def __init__(self):
		...
		taskMgr.doMethodLater(0.300, self.ImagePublisher, 'ImagePublisher')
        # cv2.namedWindow("1", 0)
        

		
	def ImagePublisher(self,task):
		...
		tex.write("catkin_workspace/src/ros_image/scripts/ImageBuffer.jpg")
